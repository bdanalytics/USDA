...
title: "USDA:National Nutrient Database: Calories regression:: USDA2"
author: "bdanalytics"
...
Data: 
Source: 
    Training:   https://courses.edx.org/asset-v1:MITx+15.071x_2a+2T2015+type@asset+block/USDA.csv  
    New:        <newdt_url>  
Time period: 
...
glb_trnng_url <- "https://courses.edx.org/asset-v1:MITx+15.071x_2a+2T2015+type@asset+block/USDA.csv"
...
glb_rsp_var_raw <- "Calories"

# for classification, the response variable has to be a factor
glb_rsp_var <- glb_rsp_var_raw # or "Calories.fctr"
...
glb_exclude_vars_as_features <- union(glb_exclude_vars_as_features, 
                                      c(NULL, "Description.fctr")) # or c("<col_name>")
...
glb_trnobs_df <- myimport_data(url=glb_trnng_url, comment="glb_trnobs_df", 
                                force_header=TRUE)
glb_trnobs_df <- subset(glb_trnobs_df, !is.na(Calories))
...
dsp_numeric_vars_dstrb <- function(vars_lst) {
    for (var in vars_lst) {
        ...
        if (glb_is_regression)
            gp <- myplot_scatter(df=glb_allobs_df, ycol_name=glb_rsp_var, xcol_name=var,
                                 smooth=TRUE)
        if (glb_is_classification)
...
dsp_numeric_vars_dstrb(setdiff(names(glb_allobs_df), c(myfind_chr_cols_df(glb_allobs_df), 
                                    glb_rsp_var_raw, glb_rsp_var, glb_exclude_vars_as_features)))
